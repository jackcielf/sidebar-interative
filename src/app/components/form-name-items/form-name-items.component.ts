...
export class FormNameItemsComponent implements OnInit {
  ...
  items = [
    ...
    {icon: 'open_in_new', value: 'redirectto', viewValue: 'Redirecionar para '},
    ...
    {icon: 'add_photo_alternate', value: 'addimg', viewValue: 'Adicionar imagem'},
    ...
    {icon: 'supervisor_account', value: 'myfriends', viewValue: 'Meus amigos'},
    ...
    {icon: 'add_shopping_cart', value: 'addcart', viewValue: 'Adicionar ao carrinho'},
